...
## Project Structure
    ...
    ├── bookstore_network_m_37963  # Django project configurations
...
1. Clone this repo and `cd bookstore_network_m_37963`
...
2. Clone this repo and `cd bookstore_network_m_37963`
